...
One of the goals for my fiddling was to be able to learn more about [Dear ImGui](https://github.com/ocornut/imgui), an immediate-mode GUI library that's widely used across the industry for custom debug views and tooling. Getting ImGui working with Monogame on my mac has been a fun adventure in building and maintaining native dependencies so I figured I'd write a bit about how I got it working.
...
![ImGui demo window displaying in a MonoGame application on OSX.](img/cs-imgui.png)
...
- [cimnodes](https://github.com/AesteroidBlues/cimnodes): A tool set for creating node-based visual scripts, similar to Unreal Blueprints
...
![An ImNodes editor displaying in a MonoGame application on OSX.](img/cs-imnodes.png)
...
![A window with custom bezier curve widgets displaying in a MonoGame application on OSX.](img/cs-custom.png)
